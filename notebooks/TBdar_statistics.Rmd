...
tbdar_subset <- subset(tbdar, HIV_status =="negative" & (Introduction %in% c("other", "Intro 1", "Intro 5", "Intro 9", "Intro 10") | Nigerian > 0), select=c("age", "Southeastern_Bantu", "Eastern_Bantu", "Western_Bantu", "other",  "symptoms_duration_cough_duration", "socioeconomic_status"))
...
# look at the distribution of the outcome variables

```{r}
tbdar_subset <- subset(tbdar, HIV_status =="negative" & (Introduction %in% c("other", "Intro 1", "Intro 5", "Intro 9", "Intro 10") | Nigerian > 0) , select=c("Xray_score", "TB_score", "Ct_value"))

for (variable in c("Xray_score", "TB_score", "Ct_value")){
  hist(tbdar_subset[[variable]], main = variable, breaks = seq(min(tbdar_subset[[variable]], na.rm = T), max(tbdar_subset[[variable]], na.rm = T), length.out = 25)) 
}
```
